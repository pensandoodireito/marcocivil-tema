				...
				<div class="row">
					<div role="tabpanel">
						...
						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#textVersion" aria-controls="textVersion"
							                                          role="tab" data-toggle="tab">Texto</a></li>
							<li role="presentation"><a href="#pdfVersion" aria-controls="pdfVersion" role="tab"
							                           data-toggle="tab">Arquivo PDF</a></li>
						</ul>
						<!-- Tab panes -->
						<div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane fade" id="pdfVersion">
								<div class="mt-md">
									<input class="btn btn-primary" type="file" data-filename-placement="inside"
									       name="pauta_pdf_contribution"
									       title="Selecione o arquivo PDF que você deseja enviar.">
								</div>
							</div>
						</div>
					</div>
